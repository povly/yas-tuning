<div id="user__payment-bottom">
  <div class="user__payments-bottom">
    <div class="user__payments-left">
      <div class="user__date" data-start-date="2024-01-15" data-end-date="2024-01-25" hx-get="/php/superadmin/invoices.php" hx-target="#user__payment-bottom" hx-swapp="outerHTML" hx-trigger="userDateSelected">
  ...
  <div class="user__table-container">
    <table class="user__table user__table_superadmin-payments">
      <thead>
        <tr>
          <th>ID</th>
