...
<div class="modal order-detail-modal active" id="order-modal-<?php echo $orderId; ?>" onclick="document.getElementById('order-modal-<?php echo $orderId; ?>').remove()">
  <div class="modal__table" onclick="document.getElementById('order-modal-<?php echo $orderId; ?>').remove()">
    <div class="modal__ceil">
      <div class="modal__content order-detail-modal__content" onclick="event.stopPropagation()">
        <button class="order-detail-modal__close modal__close" onclick="document.getElementById('order-modal-<?php echo $orderId; ?>').remove()">
          ...
          <div class="order-detail-modal__content-table">
            ...
            <div class="order-detail-modal__row">
              ...
              <div class="order-detail-modal__value">
                <span class="order-detail-modal__priority"><?php echo $orderData['priority']; ?></span>
              </div>
            </div>
            ...
            <div class="order-detail-modal__row">
              ...
              <div class="order-detail-modal__value">
                ...
                <div class="order-detail-modal__download order-detail-modal__download--active">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 13L1 14C1 15.6569 2.34315 17 4 17L14 17C15.6569 17 17 15.6569 17 14L17 13M9 12L9 1M9 12L5 8M9 12L13 8" stroke="#F56E0F" stroke-width="2" />
                  </svg>
                  Download
                </div>
                <?php else: ?>
                <div class="order-detail-modal__download order-detail-modal__download--disabled">
                  Download
                </div>
                <?php endif; ?>
              </div>
            ...
            <div class="order-detail-modal__row">
              ...
              <div class="order-detail-modal__value">
                <div class="order-detail-modal__file-output">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 13L1 14C1 15.6569 2.34315 17 4 17L14 17C15.6569 17 17 15.6569 17 14L17 13M9 12L9 1M9 12L5 8M9 12L13 8" stroke="#F5F5F5" stroke-width="2" />
                  </svg>
                  File output
                </div>
              </div>
            ...
            <div class="order-detail-modal__row">
              ...
              <div class="order-detail-modal__value">
                <div class="order-detail-modal__status order-detail-modal__status--completed">
