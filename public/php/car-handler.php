...
function renderBreadcrumbs($brand_name = '', $model = '', $year = '', $motor = '', $brand_id = 0, $brand_img = '')
{
    ...
    echo '<a href="#choose-your-car" class="h-car__breadcrumb-link" hx-post="/php/car-handler.php" hx-target="#car-section" hx-vals=\'{"action":"back_to_brands"}\' href="#choose-your-car">Cars</a>';
    echo '</li>';
    if ($brand_name) {
        echo '<li class="h-car__breadcrumb h-car__breadcrumb_brand">';
        // Добавлен href="#choose-your-car"
        echo '<a href="#choose-your-car" class="h-car__breadcrumb-link" hx-post="/php/car-handler.php" hx-target="#car-section" hx-vals=\'{"action":"to_brand","brand_id":"' . $brand_id . '","brand_name":"' . $brand_name . '","brand_img":"' . $brand_img . '"}\' href="#choose-your-car">' . htmlspecialchars($brand_name) . '</a>';
        echo '</li>';
    }
    if ($model) {
        echo '<li class="h-car__breadcrumb h-car__breadcrumb_model">';
        // Добавлен href="#choose-your-car"
        echo '<a href="#choose-your-car" class="h-car__breadcrumb-link" hx-post="/php/car-handler.php" hx-target="#car-section" hx-vals=\'{"action":"to_model","brand_id":"' . $brand_id . '","brand_name":"' . $brand_name . '","brand_img":"' . $brand_img . '","model":"' . $model . '"}\' href="#choose-your-car">' . htmlspecialchars($model) . '</a>';
        echo '</li>';
    }
    if ($year) {
        echo '<li class="h-car__breadcrumb h-car__breadcrumb_year">';
        // Добавлен href="#choose-your-car"
        echo '<a href="#choose-your-car" class="h-car__breadcrumb-link" hx-post="/php/car-handler.php" hx-target="#car-section" hx-vals=\'{"action":"to_year","brand_id":"' . $brand_id . '","brand_name":"' . $brand_name . '","brand_img":"' . $brand_img . '","model":"' . $model . '","year":"' . $year . '"}\' href="#choose-your-car">' . htmlspecialchars($year) . '</a>';
        echo '</li>';
    }
    if ($motor) {
