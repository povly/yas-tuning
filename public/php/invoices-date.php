<div class="user__main-header user__main-header_download">
  <div class="user__main-header-left">
    <div class="user__date user__date_invoices" data-start-date="2024-01-15" data-end-date="2024-01-25" hx-get="/php/invoices-date.php" hx-target="#user__table-container" hx-swapp="outerHTML" hx-include=".user__date-input" hx-trigger="userDateSelected">
      <div class="user__date-item">
        ...
        <div class="user__date-title">15.01.2024 - 25.01.2024</div>
      </div>
      <div class="user__date-calendar"></div>
    </div>
  </div>
  <div class="user__main-header-right">
    <div class="user__download-btn p-btn p-btn_orange">Download</div>
  </div>
</div>
<div class="user__table-container">
  <table class="user__table user__table_invoices">
    <thead>
      <tr>
        <th>ID</th>
    ...
    <tbody>
      <tr>
        <td>19659</td>
        <td>1EW69976K6635934F</td>
        <td>
          <button class="user__download user__download--disabled">Download</button>
        </td>
        <td>
          <div class="user__status user__status--start">Start</div>
        </td>
        <td>100</td>
      ...
      <tr>
        <td>19659</td>
        <td>1EW69976K6635934F</td>
        <td><a class="user__download user__download--active" href="#!">Download</a></td>
        <td>
          <div class="user__status user__status--start">Start</div>
        </td>
        <td>100</td>
