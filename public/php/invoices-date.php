  ...
  <div class="user__main-header user__main-header_download">
    <div class="user__main-header-left">
      <div class="user__date user__date_invoices" hx-get="/php/invoices-date.php" hx-target="#user__table-container" hx-swapp="outerHTML" hx-include=".user__date-input" hx-trigger="userDateSelected">
